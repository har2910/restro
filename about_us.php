        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>About Us</h1>
                    <p>From changing the way India eats, to elevating the quality of life for urban consumers with unparalleled convenience... Swiggy has come a long way. We’re chasing this disruptive vision with purpose, to make life a little easier, a little happier, and a lot more fulfilling.

The journey has just begun and you’re invited to join us.

Check out exciting opportunities at careers.swiggy.com</p>
                    <!-- end:Steps -->
                </div>
            </div>
            <!--end:Hero inner -->
